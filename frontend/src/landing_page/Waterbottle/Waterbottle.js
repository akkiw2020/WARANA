...
function Waterbottle() {
  ...
  const [systemProducts, setSystemProducts] = useState([
    { id: "s9", name: "Waterbottle-1L", price: 20, image: "waterbottle.jpg.png", isOutOfStock: false },
    { id: "s10", name: "Waterbottle-500ml", price: 10, image: "waterbottle500.png", isOutOfStock: false },
  ]);
  ...
  const fetchProducts = async () => {
    try {
      ...
      // 1. Get products that explicitly have the "Water Bottle" category
      const categoryDbProducts = allProducts.filter(p => 
        p.category.toLowerCase() === "water bottle" || 
        p.category.toLowerCase() === "waterbottle" ||
        p.category.toLowerCase() === "battels" ||
        p.category.toLowerCase() === "bottle"
      );
  ...
  return (
    <div style={{ padding: "40px", maxWidth: "1200px", margin: "0 auto" }}>
      ...
      <h2 style={{ textAlign: "center", color: "#333" }}>Available Water Bottles</h2>

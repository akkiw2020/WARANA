...
function Biscuits() {
  ...
  const [systemProducts, setSystemProducts] = useState([
    { id: "b1", name: "Fruit Biscuit", price: 40, image: "fruit.jpg", isOutOfStock: false },
    { id: "b2", name: "Osmania Biscuit", price: 35, image: "osmania.jpg", isOutOfStock: false },
    { id: "b3", name: "Cashew Biscuit", price: 40, image: "cashewbiscuit.jpg", isOutOfStock: false },
    { id: "b4", name: "Choco Chip Cookies", price: 42, image: "chocochipcookies.jpg", isOutOfStock: false },
  ]);
  ...
  const fetchProducts = async () => {
    try {
      ...
      // 1. Get products that explicitly have the "Biscuits" category
      const categoryDbProducts = allProducts.filter(p => 
        p.category.toLowerCase() === "biscuits" || 
        p.category.toLowerCase() === "biscuit"
      );
      ...
      console.error("Error fetching biscuits:", err);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div style={{ padding: "40px", maxWidth: "1200px", margin: "0 auto" }}>
      ...
      <h2 style={{ textAlign: "center", color: "#333" }}>Available Biscuits</h2>
